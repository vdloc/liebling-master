...
/* harmony import */ var _utils_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/api */ "./js/utils/api.js");
/* harmony import */ var _utils_dom__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/dom */ "./js/utils/dom.js");
/* harmony import */ var _utils_helpers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/helpers */ "./js/utils/helpers.js");
...
var Category = /*#__PURE__*/function () {
  function Category() {
    ...
    this.postContainer = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.select)('#posts-container');
    this.featuredPostsContainer = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.select)('#featured-posts-container', this.postContainer);
    this.loadMoreButton = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.select)('#load-more-button');
    this.loader = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.select)('#posts-loader');
    this.nonFeaturedPosts = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.selectAll)('.js-post-card');
    this.postTemplate = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.select)('#post-card-template').innerHTML;
    this.categoryInfo = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.select)('#category-info');
    this.categoryTag = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.getAttr)(this.categoryInfo, 'data-tag'); // State
  ...
  _createClass(Category, [{
    ...
    value: function init() {
      ...
      this.setupLoadingUI();
      (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.bindEvent)(this.loadMoreButton, 'click', this.handleLoadMorePost);
    }
  }, {
    key: "setupFeaturedPostsSlider",
    value: function setupFeaturedPostsSlider() {
      var swiperContainer = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.select)('.swiper', this.featuredPostsContainer);
      var swiperNextEl = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.select)('.js-featured-slider-next', swiperContainer);
      var swiperPrevEl = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.select)('.js-featured-slider-prev', swiperContainer);
      var swiperOptions = {
      ...
      new _components_Slider__WEBPACK_IMPORTED_MODULE_1__["default"]({
        ...
        modules: [swiper__WEBPACK_IMPORTED_MODULE_2__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_2__.EffectFade]
      });
    }
  }, {
    key: "updateLoadingUI",
    value: function updateLoadingUI() {
      ...
      (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.toggleClass)(this.loadMoreButton, isHideLoadMoreButton, hiddenClass);
      (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.toggleClass)(this.loader, !this.isLoading, hiddenClass);
    }
  }, {
    key: "setupLoadingUI",
    value: function () {
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 6:
                ...
                if (this.nonFeaturedPostsCount >= this.totalNonFeaturedPostsCount) {
                  (0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.addClass)(this.loadMoreButton, hiddenClass);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return _utils_api__WEBPACK_IMPORTED_MODULE_3__["default"].getPosts({
                  limit: limit,
                  include: 'tags',
    ...
    value: function createPostHTML(postData) {
      ...
      var mappingConfig = {
        ...
        '@time': published_at,
        '@ago': (0,_utils_helpers__WEBPACK_IMPORTED_MODULE_5__.convertToTimeAgo)(published_at)
      };
      return (0,_utils_helpers__WEBPACK_IMPORTED_MODULE_5__.replateTemplateContent)(this.postTemplate, mappingConfig);
    }
  }]);
...
(0,_utils_dom__WEBPACK_IMPORTED_MODULE_4__.onReady)(function () {
  new Category();
});
