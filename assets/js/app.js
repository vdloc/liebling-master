...
var bodyHideOverflowClass = 'overflow-hidden max-h-screen';
...
var MobileMenu = /*#__PURE__*/function () {
  ...
  _createClass(MobileMenu, [{
    ...
    value: function openMobileMenu() {
      (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.addClass)(this.body, bodyHideOverflowClass);
      (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.addClass)(this.mobileMenu, mobileMenuClass.visible);
      (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.removeClass)(this.mobileMenu, mobileMenuClass.invisible);
    }
  }, {
    key: "closeMobileMenu",
    value: function closeMobileMenu() {
      (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.removeClass)(this.body, bodyHideOverflowClass);
      (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.removeClass)(this.mobileMenu, mobileMenuClass.visible);
      (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.addClass)(this.mobileMenu, mobileMenuClass.invisible);
    ...
    value: function openCategoryMenu() {
      (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.addClass)(this.mobileCategoryMenu, categoryMenuClass.visible);
      (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.removeClass)(this.mobileCategoryMenu, categoryMenuClass.invisible);
    }
  }, {
    key: "closeCategoryMenu",
    value: function closeCategoryMenu() {
      (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.removeClass)(this.mobileCategoryMenu, categoryMenuClass.visible);
      (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.addClass)(this.mobileCategoryMenu, categoryMenuClass.invisible);
    }
  }, {
...
/* harmony import */ var _ThemeButton__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ThemeButton */ "./js/components/ThemeButton.js");
...
var PageHeader = /*#__PURE__*/function () {
  ...
  _createClass(PageHeader, [{
    ...
    value: function init() {
      ...
      this.setupSecondaryNavigation();
      this.observeHeader();
      new _ThemeButton__WEBPACK_IMPORTED_MODULE_3__["default"]('#theme-control', true);
      new _ThemeButton__WEBPACK_IMPORTED_MODULE_3__["default"]('#mobile-theme-control');
    ...
    value: function setupPrimaryNavigation() {
      this.primaryNavigation.forEach(function (navigation) {
        var subMenu = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.select)('.js-submenu', navigation);
        ...
        if (sliderContainer) {
          new _Slider__WEBPACK_IMPORTED_MODULE_1__["default"]({
            ...
            prevEl: sliderPrevEl,
            nextEl: sliderNextEl,
            options: _objectSpread(_objectSpread({}, sliderOptions), {}, {
              on: {
                init: function init() {
                  (0,_utils_dom__WEBPACK_IMPORTED_MODULE_0__.addClass)(subMenu, 'sm:group-hover:animate-open-sub-menu');
                }
              }
            })
          });
...
/* harmony import */ var tippy_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tippy.js */ "./node_modules/tippy.js/dist/tippy.chunk.esm.js");
...
var Search = /*#__PURE__*/function () {
  function Search() {
    ...
    this.openSearchButton = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_1__.select)('#search-button');
    this.openSearchMobileButton = (0,_utils_dom__WEBPACK_IMPORTED_MODULE_1__.select)('#search-button-mobile');
  ...
  _createClass(Search, [{
    ...
    value: function init() {
      ...
      [this.openSearchButton, this.openSearchMobileButton].forEach(function (button) {
        (0,_utils_dom__WEBPACK_IMPORTED_MODULE_1__.bindEvent)(button, 'click', _this.openModal);
      });
      (0,tippy_js__WEBPACK_IMPORTED_MODULE_4__.t)(this.openSearchButton, {
        content: 'Tìm kiếm'
      });
